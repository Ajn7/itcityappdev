...
//             state is CartAddRefreshLoadedState) {
//           setState(() {
//             this.cartcount =
//                 BlocProvider.of<CartBloc>(context).currentCartList.length;
//           });
//         }
...
//                           ),
//                           badgeStyle:
//                               badge.BadgeStyle(badgeColor: AppColors.WHITE),
//                         ),
//                 ),
//               ],
...
//               ),
//             ),
//             bottomNavigationBar: BottomNavigationProductNew(
//               product: product,
...
//                             color: AppColors.WHITE,
//                             child: Center(
//                               child: multipleImageModel!.data!.length <= 1
//                                   ? Image.network(
//                                       product == null
//                                           ? ''
...
//                                                 children: multipleImageModel!
//                                                     .data!
//                                                     .map((item) {
//                                                   print(_current);
//                                                   int index =
//                                                       multipleImageModel!.data!
//                                                           .indexOf(item);
//                                                   return Container(
//                                                     width: 25.0,
//                                                     height: 3.0,
...
//                                   children: [
//                                     BlocBuilder<RandomReviewBloc,
//                                         RandomReviewState>(
//                                       builder: (context, state) {
//                                         if (state is RandomReviewLoaded) {
//                                           this.rating =
//                                               BlocProvider.of<RandomReviewBloc>(
//                                                       context)
//                                                   .ratingReview;
//                                           print('rating' +
...
//                                 Padding(
//                                   padding:
//                                       const EdgeInsets.fromLTRB(15, 5, 30, 5),
//                                   child: Text(
//                                     'More About Product',
//                                     style: (TextStyle(
//                                       // fontFamily: 'YanoneKaffeesatz',
        ...
        buildWhen: (pstate, state) {
          if ((state is ProductByProductIdLoadedState &&
            ...
            if (product == null) {
              ...
              print('inside build product $product');
