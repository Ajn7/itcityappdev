...
class _ProfilePageNewState extends State<ProfilePageNew> {
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                Image.asset(
                                  'assets/images/icons/icon_address.png',
                                  width: 25,
                                  height: 25,
                                ),
                                SizedBox(
                        ...
                        GestureDetector(
                          onTap: () => MapsLauncher.launchQuery(
                              'IT City Online Store,Habeeb Munawer St, Al Farwaniyah, Kuwait'),
                          child: Padding(
                            padding: const EdgeInsets.fromLTRB(15, 0, 15, 10),
                            child: Row(
                              children: [
  ...
  void _onShare(BuildContext context) async {
    ...
    await Share.share(
        "Check out this awesome app, Awesome offers and amazing products https://play.google.com/store/apps/details?id=com.itcityonlinestore.itcity_online_store",
