...
class SplashScreenState extends State<SplashScreen> {
  ...
  fetchDatas() async {
   ...
   // BlocProvider.of<HomeBloc>(context).add(FetchHomeAds());
    ...
    BlocProvider.of<HomeBloc>(context).add(FetchHomeAdsTab());
    BlocProvider.of<HomeBloc>(context).add(FetchHomeAdsHomeAppliance());
    BlocProvider.of<HomeBloc>(context).add(FetchHomeAdsWatch());
    BlocProvider.of<HomeBloc>(context).add(FetchHomeAdsBag());
    BlocProvider.of<HomeBloc>(context).add(FetchHomeAdsPersonalCare());
    BlocProvider.of<HomeBloc>(context).add(FetchHomeAdsCamera());
    BlocProvider.of<HomeBloc>(context).add(FetchHomeAdsGaming());
    SharedPreferences prefs = await SharedPreferences.getInstance();
