...
class ComputerCollectionsCard extends StatefulWidget {
  ...
  ComputerCollectionsCard({Key? key, this.product, this.currency, this.rrating})
      : super(key: key);

  @override
  _ComputerCollectionsCardState createState() =>
      _ComputerCollectionsCardState();
}
                                    ...
                                    if (prefs.containsKey("id")) {
                                      ...
                                      cart.cartData = widget.product == null
                                          ...
                                          : widget.product!.productId
                                              .toString();
                                      cart.userId = prefs.getString('id');
                                      cart.productCount = 1;
                                      cart.productPrice =
                  ...
                  child: BlocBuilder<RandomReviewBloc, RandomReviewState>(
                    builder: (context, state) {
                      if (state is RandomReviewLoaded) {
                        this.rating = BlocProvider.of<RandomReviewBloc>(context)
                            .ratingReview;
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  widget.rrating != null
                                      ? widget.rrating!.toStringAsFixed(1)
