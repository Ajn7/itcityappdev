          ...
          builder: (context, ustate) {
            return BlocBuilder<CartBloc, CartState>(
              builder: (context, state) {
                if (ustate is CustomerInformationLoadedState ||
                    ustate is CustomerLoginSuccessState) {
                  if (state is CartDetailsLoadedState ||
                      state is CartRefreshLoadingState ||
                      state is AddProductToCartSuccessState ||
                      state is AddProductToCartLoadingState ||
                      state is CartAddRefreshLoadingState ||
                      state is CartAddRefreshLoadedState ||
                      state is RemoveProductFromCartLoadingState) {
                    cartItems =
                        BlocProvider.of<CartBloc>(context).currentCartList;
                  ...
                  return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                              "Please Log in / Sign up to add products to cart"),
                          SizedBox(
                            height: 15.0,
                          ),
                          Material(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            _itemCount != 0
                ? IconButton(
                    icon: widget.cart.productCount! > 1
                        ? Icon(Icons.remove)
            ...
            Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border(
                      left:
                          BorderSide(color: AppColors.LOGO_ORANGE, width: 1.0),
                      right:
                          BorderSide(color: AppColors.LOGO_ORANGE, width: 1.0)),
                ),
                child: Padding(
